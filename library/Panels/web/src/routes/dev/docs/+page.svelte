...
<AccentedParagraph tone="info">
  Heads up: You can highlight key info using an accented paragraph.
</AccentedParagraph>
...
<UnorderedList>
  <ListItem>
    <Paragraph>Bullet item</Paragraph>
  </ListItem>
  <ListItem>
    <Paragraph>Bullet item 2</Paragraph>
  </ListItem>
</UnorderedList>
...
<CodeBlock code={"const lazar = require('lazar');"} />
